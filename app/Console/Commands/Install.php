...
class Install extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install Knowledge software.';
    ...
    protected function askForStar()
    {
        if (User::count() === 1 && $this->confirm('Would you like to show some love by starring the repo?', true)) {
            if (PHP_OS_FAMILY === 'Darwin') {
                exec('open https://github.com/michaelravedoni/knowledge');
            }
            if (PHP_OS_FAMILY === 'Linux') {
                exec('xdg-open https://github.com/michaelravedoni/knowledge');
            }
            if (PHP_OS_FAMILY === 'Windows') {
                exec('start https://github.com/michaelravedoni/knowledge');
            }
        }
    }
